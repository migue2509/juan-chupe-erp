...
export default function Billing() {
  ...
  const openDetail = (inv) => {
    ...
    setEForm({
      ...
      delivery_client:    s.delivery_client || '',
      delivery_notes:     s.delivery_notes || '',
      delivery_lat:       s.delivery_lat ?? null,
      delivery_lng:       s.delivery_lng ?? null,
      notes:              s.notes || '',
  ...
  const handleSave = async () => {
    ...
    try {
      const payload = {
        ...
        delivery_address:   eForm.is_delivery ? (eForm.delivery_address || '') : '',
        delivery_client:    eForm.is_delivery ? (eForm.delivery_client || '') : '',
        delivery_notes:     eForm.is_delivery ? (eForm.delivery_notes || '') : '',
        delivery_lat:       eForm.is_delivery ? eForm.delivery_lat : null,
        delivery_lng:       eForm.is_delivery ? eForm.delivery_lng : null,
