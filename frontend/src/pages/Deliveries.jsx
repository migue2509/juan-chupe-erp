      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-5 items-start">
        ...
        <div className="lg:col-span-2 card p-0 overflow-hidden">
          ...
          <div className="grid px-4 py-2.5 bg-slate-50 border-b border-gray-100 text-[10px] font-semibold text-gray-400 uppercase tracking-widest gap-2"
            style={{ gridTemplateColumns: '44px 90px 80px 52px minmax(0,1fr) 70px 75px 100px 85px 70px' }}>
              ...
              return (
                <div key={d.id}>
                  <div
                    ...
                    <span className="text-xs font-medium text-brand-navy bg-blue-50 px-1.5 py-0.5 rounded-full">{d.shift_label || '—'}</span>
                    <span className="font-mono text-sm font-bold text-gray-700 text-center">{d.four_digits || '—'}</span>
                    <span className="text-sm text-gray-800">{d.address}</span>
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 backdrop-blur-sm p-4">
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-md">
            ...
            <div className="flex justify-end gap-3 px-6 py-4 border-t border-gray-100">
              ...
              <button onClick={saveEdit} className="btn-primary text-sm">Guardar cambios</button>
            </div>
          </div>
        </div>
      )}
